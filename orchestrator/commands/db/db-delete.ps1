...
if ($LASTEXITCODE -ne 0) {
    Write-Error "db-update falló durante liquibase update"
    exit 1
}

Write-Host ""
Write-Host "Base de datos '$($projectModel.Database.Name)' actualizada correctamente"
