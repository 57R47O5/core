...
from apps.base.rest_controllers.tipo_documento_identidad_rest_controller import TipoDocumentoIdentidadOptionsView
from apps.base.rest_controllers.contacto_rest_controller import ContactoRestController
from apps.base.rest_controllers.tipo_contacto_rest_controller import TipoContactoOptionsView
...
router.register(r'tipo-documento-identidad', TipoDocumentoIdentidadOptionsView, 'tipo-documento-identidad')
router.register(r'contacto', ContactoRestController, 'contacto')
router.register(r'tipo-contacto', TipoContactoOptionsView, 'tipo-contacto')
